...
part of 'search_type_with_song_netease.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SearchTypeWithSongNetease _$SearchTypeWithSongNeteaseFromJson(
    Map<String, dynamic> json) {
  return SearchTypeWithSongNetease(
    json['result'] as int,
    json['data'] == null
        ? null
...
Map<String, dynamic> _$SearchTypeWithSongNeteaseToJson(
        SearchTypeWithSongNetease instance) =>
    <String, dynamic>{
