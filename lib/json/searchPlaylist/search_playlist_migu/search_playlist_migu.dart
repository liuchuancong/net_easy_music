...
part 'search_playlist_migu.g.dart';

@JsonSerializable()
class SearchPlaylistMigu extends Object {
  @JsonKey(name: 'result')
  int result;
  ...
  factory SearchPlaylistMigu.fromJson(Map<String, dynamic> srcJson) =>
      _$SearchPlaylistMiguFromJson(srcJson);

  Map<String, dynamic> toJson() => _$SearchPlaylistMiguToJson(this);
}
