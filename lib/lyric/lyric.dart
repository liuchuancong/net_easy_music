...
class Lyric extends StatefulWidget {
  ...
  final LyricContent lyricTranslation;
...
class LyricPainter extends ChangeNotifier implements CustomPainter {
  ...
  LyricContent lyricTranslation;

  List<TextPainter> lyricPainters;

  List<TextPainter> lyricTranslationPainters;
  ...
  LyricPainter(TextStyle style, this.lyric, this.lyricTranslation,
      {this.textAlign = TextAlign.center, Color highlight = Colors.red}) {
    assert(lyric != null);
    lyricPainters = [];
    lyricTranslationPainters = [];
